...
export default function DetailCard({ close, name,description, directions, state ,id }) {
  ...
  return (
    <>
   { plan ? <PlanActivity close={closePlan} id={id} name={name} m="mr-96"/>:null }
    ...
    >
      ...
      <div className="h-full w-full  p-9 flex flex-col space-y-8 ">
        ...
        <div className="flex w-full justify-around">
          <p className="text-2xl text-blue-800 hover:text-red-400 cursor-pointer" onClick={()=> {
            setShow(false)
            setPlan(!plan)}}>
          {plan ? "Unplan" : "Plan"}
          </p>
